...
int main (int argc, char *argv[]) {
	...
	s = "./deutone/ecc.txt";
	s_raggioq = "./deutone/rq_ecc.txt";
	s_p_y = "./deutone/P_y_ecc.txt";
	s_a_y = "./deutone/A_y_ecc.txt";
	s_p = "./deutone/P_ecc.txt";
	s_vec_deutone = "./deutone/Vec_d_ecc.txt";
	s_matrice = "./deutone/Mat_ecc.txt";
