...
void init_main_0(const unsigned short & A,
	...
	{
		s = "Nuova_E_0_" + scrivi(A) + "_" + Corpi.scrivi_corpi() + "__m_max_" + scrivi(m_max) + "_K_max_[" + scrivi(K_min) + "-" + scrivi(K_max) + "]";
		
		s_0 = "Nuova_Tabella_E_0_" + scrivi(A) + "_" + Corpi.scrivi_corpi() + "__m_max_" + scrivi(m_max) + "_K_max_[" + scrivi(K_min) + "-" + scrivi(K_max) + "]";
		
		s_0_p = "Nuova_Tabella_E_0_" + scrivi(A) + "_" + Corpi.scrivi_corpi() + "__m_max_" + scrivi(m_max) + "_K_max_[" + scrivi(K_min) + "-" + scrivi(K_max) + "]";
		
		s_0_d = "Nuova_Tabella_E_0_" + scrivi(A) + "_" + Corpi.scrivi_corpi() + "__m_max_" + scrivi(m_max) + "_K_max_[" + scrivi(K_min) + "-" + scrivi(K_max) + "]";
		
		s_1 = "Nuova_E_0_" + scrivi(A) + "_" + Corpi.scrivi_corpi() + "__m_max_" + scrivi(m_max) + "_K_max_[" + scrivi(K_min) + "-" + scrivi(K_max) + "]";
		
		s_l = "Livelli_E_0_" + scrivi(A) + "_" + Corpi.scrivi_corpi() + "__m_max_" + scrivi(m_max) + "_K_max_[" + scrivi(K_min) + "-" + scrivi(K_max) + "]";
		
		s_misurabili = "Misurabili_" + scrivi(A) + "_" + Corpi.scrivi_corpi() + "__m_max_" + scrivi(m_max) + "_K_max_[" + scrivi(K_min) + "-" + scrivi(K_max) + "]";
	}
	{
	...
	for (double beta = 0.4; beta <= (double)beta_max + 0.2; beta+=0.2) {
		...
		Energia_radiale ER ( N, G, HI, K_min, m_max, Corpi.C(), Corpi.M(), Corpi.M_R(),clus,beta);
		...
		for (unsigned short K_max_temp = K_min; K_max_temp <= K_max; K_max_temp+=incremento) {
			...
			if(BASE.D()>11500){
				...
				if(BASE.D_h_p() > 0){
					...
					std::cerr << "gerato mygen1 " << std::endl;
...
int main (int argc, char *argv[]) {
	...
	if (argc == 1){
		std::cerr << "Sintassi: A m_max K_min K_max nucleoni masse_uguali beta_max [modo_H]" << std::endl;
		return true;
	}
	...
	unsigned short beta_max = ((unsigned short) std::strtoul(argv[6+A],(char **)0, 10));
	...
	init_main_0(A,m_max,K_min,K_max,Corp,modo_cluster,beta_max);
	return true;
}